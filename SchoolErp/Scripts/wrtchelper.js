var WrtcHelper = (function () {
    ...
    function eventBinding() {
        $("#btnMuteUnmute").on('click', async function () {
            ...
            if (_isAudioMute) {
                ...
                //$(this).text("Mute");
                $("#microphone").removeClass("fa fa-microphone-slash fa-3x");
                $("#microphone").addClass("fa fa-microphone fa-3x");
                AddUpdateAudioVideoSenders(_audioTrack, _rtpAudioSenders);
            }
            else {
                _audioTrack.enabled = false;
                //$(this).text("Unmute");
                $("#microphone").removeClass("fa fa-microphone fa-3x");
                $("#microphone").addClass("fa fa-microphone-slash fa-3x");
    ...
    async function ManageVideo(_newVideoState) {
        ...
        if (_newVideoState == VideoStates.None) {
            ...
            $("#vediocamra").removeClass("fa fa-video-camera fa-3x");
            $("#vediocamra").addClass("fa fa-video-camera fa-3x");
            //$("#btnStartStopScreenshare").text('Screen Share');
            $("#aviscreenshare").addClass('fa fa-desktop');
